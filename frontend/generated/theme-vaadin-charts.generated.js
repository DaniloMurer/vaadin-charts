...
import stylesCss from 'themes/vaadin-charts/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_vaadin-charts_componentCss']) {
    
    document['_vaadintheme_vaadin-charts_componentCss'] = true;
  }
